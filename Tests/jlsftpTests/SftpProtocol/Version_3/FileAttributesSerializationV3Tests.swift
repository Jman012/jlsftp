...
final class FileAttributesSerializationV3Tests: XCTestCase {
	...
	func testFlags() {
		...
		XCTAssertEqual(
			jlsftp.SftpProtocol.Version_3.FileAttributesFlags(rawValue: 0x0000_0001),
			jlsftp.SftpProtocol.Version_3.FileAttributesFlags.size)
		XCTAssertEqual(
			jlsftp.SftpProtocol.Version_3.FileAttributesFlags(rawValue: 0x0000_0002),
			jlsftp.SftpProtocol.Version_3.FileAttributesFlags.userAndGroupIds)
		XCTAssertEqual(
			jlsftp.SftpProtocol.Version_3.FileAttributesFlags(rawValue: 0x0000_0004),
			jlsftp.SftpProtocol.Version_3.FileAttributesFlags.permissions)
		XCTAssertEqual(
			jlsftp.SftpProtocol.Version_3.FileAttributesFlags(rawValue: 0x0000_0008),
			jlsftp.SftpProtocol.Version_3.FileAttributesFlags.accessAndModificationTimes)
		XCTAssertEqual(
			jlsftp.SftpProtocol.Version_3.FileAttributesFlags(rawValue: 0x8000_0000),
			jlsftp.SftpProtocol.Version_3.FileAttributesFlags.extendedAttributes)
	}
	...
	func testDeserializeMinimal() {
		...
		let serialization = jlsftp.SftpProtocol.Version_3.FileAttributesSerializationV3()
	...
	func testDeserializePermissions() {
		...
		let expectedFileAttrs = FileAttributes(sizeBytes: nil,
											   userId: nil,
											   groupId: nil,
											   permissions: Permissions(user: [.read, .write, .execute], group: [.read, .execute], other: [.write], mode: [], fileType: nil),
											   accessDate: nil,
											   modifyDate: nil,
											   linkCount: nil,
											   extensionData: [])
	...
	func testSerializePermissions() {
		...
		let fileAttrs = FileAttributes(sizeBytes: nil,
									   userId: nil,
									   groupId: nil,
									   permissions: Permissions(user: [.read], group: [.write], other: [.execute], mode: [], fileType: nil),
									   accessDate: nil,
									   modifyDate: nil,
									   linkCount: nil,
									   extensionData: [])
