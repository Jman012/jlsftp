...
final class HandleReplyPacketSerializationHandlerTests: XCTestCase {
	...
	private func getHandler() -> jlsftp.SftpProtocol.Version_3.HandleReplyPacketSerializationHandler {
		return jlsftp.SftpProtocol.Version_3.HandleReplyPacketSerializationHandler()
	}
