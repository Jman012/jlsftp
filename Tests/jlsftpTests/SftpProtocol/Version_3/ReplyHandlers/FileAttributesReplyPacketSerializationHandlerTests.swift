...
final class FileAttributesReplyPacketSerializationHandlerTests: XCTestCase {
	...
	private func getHandler() -> jlsftp.SftpProtocol.Version_3.FileAttributesReplyPacketSerializationHandler {
		return jlsftp.SftpProtocol.Version_3.FileAttributesReplyPacketSerializationHandler()
	}
