...
final class ReadDirectoryPacketSerializationHandlerTests: XCTestCase {
	...
	private func getHandler() -> jlsftp.SftpProtocol.Version_3.ReadDirectoryPacketSerializationHandler {
		return jlsftp.SftpProtocol.Version_3.ReadDirectoryPacketSerializationHandler()
	}
