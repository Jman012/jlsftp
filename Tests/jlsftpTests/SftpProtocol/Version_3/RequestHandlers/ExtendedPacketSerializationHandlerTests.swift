...
final class ExtendedPacketSerializationHandlerTests: XCTestCase {
	...
	private func getHandler() -> jlsftp.SftpProtocol.Version_3.ExtendedPacketSerializationHandler {
		return jlsftp.SftpProtocol.Version_3.ExtendedPacketSerializationHandler()
	}
	...
	func testSerializeValid() {
		...
		XCTAssertNil(handler.serialize(packet: .extended(packet), to: &buffer))
