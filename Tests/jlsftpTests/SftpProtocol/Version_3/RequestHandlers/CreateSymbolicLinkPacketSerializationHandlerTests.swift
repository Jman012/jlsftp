...
final class CreateSymbolicLinkSerializationHandlerTests: XCTestCase {
	...
	private func getHandler() -> jlsftp.SftpProtocol.Version_3.CreateSymbolicLinkPacketSerializationHandler {
		return jlsftp.SftpProtocol.Version_3.CreateSymbolicLinkPacketSerializationHandler()
	}
