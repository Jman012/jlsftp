...
final class HandleStatusPacketSerializationHandlerTests: XCTestCase {
	...
	private func getHandler() -> jlsftp.SftpProtocol.Version_3.HandleStatusPacketSerializationHandler {
		return jlsftp.SftpProtocol.Version_3.HandleStatusPacketSerializationHandler()
	}
	...
	func testSerializeValid() {
		...
		XCTAssertNil(handler.serialize(packet: .handleStatus(packet), to: &buffer))
