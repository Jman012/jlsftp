...
final class RenamePacketSerializationHandlerTests: XCTestCase {
	...
	private func getHandler() -> jlsftp.SftpProtocol.Version_3.RenamePacketSerializationHandler {
		return jlsftp.SftpProtocol.Version_3.RenamePacketSerializationHandler()
	}
	...
	func testSerializeValid() {
		...
		XCTAssertNil(handler.serialize(packet: .rename(packet), to: &buffer))
