...
final class InitializePacketSerializationHandlerTests: XCTestCase {
	...
	private func getHandler() -> jlsftp.SftpProtocol.Version_3.InitializePacketSerializationHandler {
		return jlsftp.SftpProtocol.Version_3.InitializePacketSerializationHandler()
	}
	...
	func testDeserializeValid() {
		...
		XCTAssertEqual(jlsftp.SftpProtocol.SftpVersion.v3, initPacket.version)
