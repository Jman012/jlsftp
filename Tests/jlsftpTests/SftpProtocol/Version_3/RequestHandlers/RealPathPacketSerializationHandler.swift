...
final class RealPathPacketSerializationHandlerTests: XCTestCase {
	...
	private func getHandler() -> jlsftp.SftpProtocol.Version_3.RealPathPacketSerializationHandler {
		return jlsftp.SftpProtocol.Version_3.RealPathPacketSerializationHandler()
	}
