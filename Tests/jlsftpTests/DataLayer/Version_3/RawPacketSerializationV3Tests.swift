...
final class RawPacketSerializationV3Tests: XCTestCase {
	...
	private func getSerialization() -> jlsftp.DataLayer.Version_3.RawPacketSerializationV3 {
		return jlsftp.DataLayer.Version_3.RawPacketSerializationV3(sshProtocolSerialization: SSHProtocolSerializationDraft9())
	}
