...
final class PermissionsV3Tests: XCTestCase {
	...
	let testCases: [(binary: UInt16, expUser: jlsftp.DataLayer.Version_3.PermissionV3, expGroup: jlsftp.DataLayer.Version_3.PermissionV3, expOther: jlsftp.DataLayer.Version_3.PermissionV3)] = [
		// Test Other
		(0o000, [], [], []),
		(0o001, [], [], [.execute]),
		(0o002, [], [], [.write]),
